...
parser.add_argument('--parallelsignalstart', type=float, help='Series Signal start (ns)', default=160)
parser.add_argument('--parallelsignalend', type=float, help='Series Signal end (ns)', default=320)
