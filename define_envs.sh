...
export RE_RECO_FOLDER="${RECO_UNPACKED_OUTDIR}/re-reco_dqm_template"
...
export REMOTE_LAST_FILE="${RECO_UNPACKED_OUTDIR}/last_file.txt"

export XROOTD_SERVER="root://eospublic.cern.ch/"

export FRAGMENT_HADD_INTERVAL=2
